...
class TestRaceConditionDetectorCleanCode:
    def test_exception_based_open_returns_no_findings(self, neutral_tmp):
        ...
        config = RaceConditionScanConfig(scan_path=neutral_tmp)
...
class TestRaceConditionDetectorBadCode:
    def test_toctou_exists_then_open_detected(self, neutral_tmp):
