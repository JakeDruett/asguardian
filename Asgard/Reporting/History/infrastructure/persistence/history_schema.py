"""
Asgard History Store - database schema and helpers.

SQLite schema constants, connection utilities, and row-deserialization helpers
for the history persistence layer. This module is a pure infrastructure
