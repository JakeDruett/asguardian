...
Contains SQL statements and the row_to_issue conversion function shared
across issue tracker operations. This module is a pure infrastructure
concern: it holds no domain logic, only SQLite schema strings and
...
from Asgard.Shared.Issues.models.issue_models import TrackedIssue
